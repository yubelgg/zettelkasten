...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState: busters.GameState):
        ...
        "*** YOUR CODE HERE ***"
        # ghost_position = most_likely_position(ghost_beliefs)
        ghost_positions = []
        for ghost_beliefs in livingGhostPositionDistributions:
            ghost_positions.append(ghost_beliefs.argMax())
        ...
        for action in legal:
            ...
            distance = self.distancer.getDistance(next_position, nearest_ghost_position)
